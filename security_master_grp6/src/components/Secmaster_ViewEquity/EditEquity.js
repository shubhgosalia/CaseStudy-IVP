    ...
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center">
     <div className="overflow-auto max-h-[80vh]">
      <div className="bg-white p-2" style={{ width: 500 }}>
        <button className="ml-2 font-medium text-xl" onClick={() => closeModal(false)}>X</button>
        <h1 className="font-semibold text-center text-xl text-gray-700 mt-5 mb-5">
          Edit Equity Details
        </h1>
          ...
          <div className="flex flex-col">
              ...
              className={`border border-gray-700 p-2 rounded mb-5 ml-5 mr-5 ${
                validationErrors.tot_shares ? 'border-red-500' : ''
                 ...
                 {validationErrors.tot_shares && (
                        <p className="text-red-500 ml-5">{validationErrors.tot_shares}</p>
                )}
            ...
            <input
              ...
              {validationErrors.open_price && (
                           <p className="text-red-500 ml-5">{validationErrors.open_price}</p>
              )}
              ...
              className={`border border-gray-700 p-2 rounded mb-5 ml-5 mr-5 ${
                validationErrors.close_price ? 'border-red-500' : ''
                   ...
                   {validationErrors.close_price && (
                      <p className="text-red-500 ml-5">{validationErrors.close_price}</p>
                   )}
